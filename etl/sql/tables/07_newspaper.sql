  ...
  CREATE INDEX idx_articles_slug ON newspaper_articles(slug);
  CREATE INDEX idx_articles_category ON newspaper_articles(category_id);
  CREATE INDEX idx_articles_published ON newspaper_articles(is_published) WHERE is_published = TRUE;
  CREATE INDEX idx_articles_featured ON newspaper_articles(is_featured) WHERE is_featured = TRUE;
  CREATE INDEX idx_articles_game_date ON newspaper_articles(game_date);
  CREATE INDEX idx_articles_publish_date ON newspaper_articles(publish_date DESC);
  CREATE INDEX idx_articles_author_type ON newspaper_articles(author_type);
  ...
  CREATE INDEX idx_article_player_tags_player ON article_player_tags(player_id);
  CREATE INDEX idx_article_player_tags_primary ON article_player_tags(is_primary) WHERE is_primary = TRUE;
  ...
  CREATE INDEX idx_article_team_tags_team ON article_team_tags(team_id);
  CREATE INDEX idx_article_team_tags_primary ON article_team_tags(is_primary) WHERE is_primary = TRUE;
  ...
  CREATE INDEX idx_article_game_tags_game ON article_game_tags(game_id);
  CREATE INDEX idx_article_game_tags_recap ON article_game_tags(is_recap) WHERE is_recap = TRUE;
